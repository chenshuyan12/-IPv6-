...
public class section_nurse extends AppCompatActivity {
    private String[] items = {"内科"};
    private list_info_doctor list_info_doctor = new list_info_doctor();
    private list_info_nurse list_info_nurse = new list_info_nurse();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().add(R.id.ll_content, list_info_nurse, "apple")
                .show(list_info_nurse)
                .commit();
